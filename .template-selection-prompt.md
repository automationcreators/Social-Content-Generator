...
2. Run: `python3 systems/secure-template-generator.py --action apply-template --project "/home/example/Documents/claudec/active/Social-Content-Generator" --template <template_name>`
